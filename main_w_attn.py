...
def train(input_tensor, target_tensor, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=MAX_LENGTH):
	...
	if use_teacher_forcing:
		...
		for di in range(target_length):
			decoder_output, decoder_hidden, decoder_attention = decoder(decoder_input, decoder_hidden, encoder_outputs) # encoder outputs are stacked encoder outputs.
...
decoder1 = AttnDecoderRNN(hidden_size, output_lang.n_words).to(device)# Notice output_lang.n_words
