...
#in the ideal case, encodes the “meaning” of the input sequence into 
...
This last output is sometimes called the context vector 
as it encodes context from the entire sequence. 
